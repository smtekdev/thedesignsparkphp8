...
@include('components.navbar')
    ...
    <div class="container" style="margin-top: 5%;">
        <div class="row">
          ...
          <div class="card" style="border-radius: 3rem; padding: 2%; border: 1px solid #AE042A; border-radius: 3rem;">
                        ...
                        <form method="POST" action="{{ route('contact.us.store') }}" id="contactUSForm">
                            ...
                            <div class="row" >
                                <div class="col-md-12" style="margin-top:5%;">
                                    <div class="form-group">
                                        <strong></strong>
                                        <input type="text" name="name" class="form-control ici" placeholder="Name" value="{{ old('name') }}" >
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-md-12" style="margin-top:5%;">
                                    <div class="form-group">
                                        <strong></strong>
                                        <input type="text" name="email" class="form-control ici" placeholder="Email" value="{{ old('email') }}">
                                        @if ($errors->has('email'))
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top:5%;">
                                    <div class="form-group">
                                        <strong></strong>
                                        <input type="text" name="phone" class="form-control ici" placeholder="Phone" value="{{ old('phone') }}">
                                        @if ($errors->has('phone'))
                                ...
                                <div class="col-md-12" style="margin-top:5%;">
                                    <div class="form-group">
                                        ...
                                        <select name="subject" class="form-select" id="service" value="{{ old('service') }}">                                  
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top:5%;">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="message" rows="3" class="form-control ici">{{ old('message') }}</textarea>
