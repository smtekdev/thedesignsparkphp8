...
.learn-more-section{
    background-image: url(classic-business/img/f4d255c7b4.jpg);
}
    </style>
            ...
            <div class="row about-wrap d-flex justify-content-center align-items-center">
                <div class="col-lg-6 col-md-5 col-sm-12 md-mb-5">
                    <div class="image about-bordered">
                        <img src="classic-business/img/d9f821782d.jpg" alt="image">
                    </div>
        ...
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 ...
                 <p>Keyword research helps you find which keywords are best to target and provides valuable insight into the queries that your target audience is actually searching on Google. The insight that you can get into these actual search terms can help inform content strategy as well as your larger marketing strategy.</p>
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/56ce9c566c.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/f82fa94ec3.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-1 order-lg-2 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 ...
                 <p>Broadly speaking, optimization is the act of changing an existing process in order to increase the occurrence of favorable outcomes and decrease the occurrence of undesirable outcomes.</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);">
                    Read Full Story
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
        ...
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 ...
                 <p>Link building is a search engine optimization technique that increases your search engine ranking. Links are one of the primary ways that search engine algorithms determine the relevance of a page. Having a good number of links to a website indicates that the content is there is valuable.</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);">
                    Read Full Story
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/b33972a039.jpg" alt="image">
              </div>
              <!-- <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
