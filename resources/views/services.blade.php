        ...
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2>Research</h2>
                 <p>Our specialized research methods give us valuable insight in your business, your industry, and your customers. Our team that comprises of account managers, web strategists, web designers, and technical managers address aspects such as target audience, brand positioning, and user-flow early in the process. This puts us in a better position to create a website that suits your specific needs. </p>
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/blog-1.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/blog-2.jpg" alt="image">
              </div>
        ...
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 ...
                 <p>By analyzing your business, we create a website guaranteed to increase conversion and produce noticeable results. We understand the important of uniqueness in this world that is filled with copies, so our creative team ensures that every website we work on is truly distinct. In most cases, we start the design process from scratch.</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);">
                    Read Full Story
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/blog-3.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
